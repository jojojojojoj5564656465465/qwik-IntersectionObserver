...
export default component$(() => {
  return (
    <section class="section-ob2">
      ...
      <Square id={51} />
      <p>
        r iure quam vitae magnam reprehenderit deleniti deserunt distinctio ipsa
        orum reprehenderit quod magni sit, deserunt cumque ut
        ...
        reiciendis facere illo quis! Assumenda natus consequatur eligendi
         accusamus? Nam necessitatibus voluptate
        ...
        tae et ab veritatis ad officiis ipsa amet
       laborum eveniet minus,
      ...
      <p>
        Ce composant est observé par IntersectionObserver. Lorem ipsum dolor sit
        amet consectetur, adipisicing elit. Molestiae corporis blanditiis
        reiciendis consequatur impedit. Aperiam vitae mollitia voluptate
        voluptates molestiae quae alias excepturi doloribus sint provident at
        repellendus velit dolorum veniam atque accusantium, sequi optio beatae.
        Ullam quos nihil iusto sed autem placeat provident est, modi numquam
        obcaecati voluptatem! Deleniti quas accusantium nobis, suscipit
        reiciendis natus sunt eaque sit veritatis aperiam distinctio quam
        placeat. Voluptate vel non fugit autem, minus quod, nihil sit harum
        impedit, quidem culpa alias molestiae assumenda ab. Numquam obcaecati
        vel, rerum, molestias nesciunt nam fugiat, nihil sed inventore quod
        provident. Consequuntur odit iusto minus ab totam!
      </p>

      <Square id={3} />

      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas magnam, consectetur pariatur repudiandae optio reprehenderit in voluptate perspiciatis neque itaque rem iste, et rerum eveniet officiis quibusdam voluptatum ea eligendi magni cupiditate voluptatem eius ratione tenetur dicta. Debitis quisquam hic ipsam quaerat aspernatur dolorem eaque neque est placeat totam eos quasi quae laudantium iste consequatur perferendis repudiandae, veniam quo nihil quidem eius nulla, minus dignissimos. Vero fugit reiciendis eos quibusdam voluptate? Aliquid ducimus quas veritatis. Fugiat vero illo nulla obcaecati voluptate, beatae a laborum aperiam temporibus veritatis excepturi animi alias itaque facere porro inventore repellat, sed, et fugit amet repudiandae?</p>
    </section>
  );
});